...
class _RegisterAdminPageState extends State<RegisterAdminPage> {
  ...
  void _handleRegister() async {
    ...
    if (name.isEmpty || email.isEmpty || phone.isEmpty || password.isEmpty || pharmacyName.isEmpty || pharmacyAddress.isEmpty) {
    ...
    // Menggunakan registerAdmin untuk menyimpan data apotek
    bool success = await authProvider.registerAdmin(
      name, 
      email, 
      password, 
      phone, 
      pharmacyAddress, // Sebagai ID sementara
      pharmacyName
    );
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Buat akun admin untuk mengelola apotek kamu di MedFast.',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.white,
                      height: 1.4,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _inputField('Nama Lengkap', Icons.person_outline, _nameController),
                  const SizedBox(height: 16),
                  _inputField('Email', Icons.mail_outline, _emailController),
                  const SizedBox(height: 16),
                  _inputField('Nomor HP', Icons.phone_outlined, _phoneController),
                  const SizedBox(height: 16),
                  ...
                  const SizedBox(height: 12),
                  _inputField('Nama Apotek', Icons.storefront_outlined, _pharmacyNameController),
                  const SizedBox(height: 16),
                  _inputField('Alamat Apotek', Icons.location_on_outlined, _pharmacyAddressController),
